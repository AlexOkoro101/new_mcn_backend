...
@include('includes.data-menu')
   ...
   <li><a href="{{url('/data/airtel')}}" style="color:#4169E1">Airtel</a></li>
    ...
    <div class="3u 12u(narrower) 12u(mobile)">
            <img src="{{asset('img/airtel2.png')}}" width="200px" class="data-header-img">
   </div>
   <div class="9u 12u(narrower) data-intro">
      <h1>Enjoy super fast and reliable data to stay connected and never miss out on information with the Airtel SmartSPEEDO Data Plans. Now available to everyone at the best prices ever!</h1>
     </div>
    </div>
      <header class="major">
      <h2><strong>Airtel&nbsp;</strong>Data&nbsp;<strong>Options</strong></h2>
      </header>
              <div class="row">
...
<div id="ss_menu" style="text-align: left !important">
    ...
    <div class="ss_content">Yes. Please dial *127*0# to check your Airtel data bundle balance.</div><br>
    ...
    <div class="ss_content">Our Airtel Data Plans work perfectly with all internet enabled devices. But please note that functionality may be restricted on older Blackberry devices.</div><br>
    <div class="ss_button">HOW LONG DOES THE DATA LAST?</div>
    <div class="ss_content">All our Airtel Data Bundles are valid for 30 days, but depending on your usage, it may be exhausted before that time.</div><br>
