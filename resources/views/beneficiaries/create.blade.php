	 ...
	 <article id="main">
		...
		<div class="row 150%">
            ...
            <div class="content">
                ...
                @endif
                  <form action="{{url('beneficiaries/store')}}" method="POST" onsubmit="return validateMyForm();">
           {{csrf_field()}}
                    <div class="row 50%">
                      ...
                      <div class="6u 12u(mobile) {{ $errors->has('email') ? ' has-error' : '' }}">
                        <input type="text" name="phone" placeholder="Type your Phone"  style="background-color: white" />
                        @if ($errors->has('phone'))
                                <span class="help-block">  
