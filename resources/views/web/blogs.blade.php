            ...
            <ol class="breadcrumb" style="text-align:left">
	            ...
	            <div class="web-header">
	                ...
	                <div class="web-message col-xs-12 col-sm-6 col-md-6 col-lg-9">              
	                    <h2 class="display-3">You need your voice heard <i>Blogging</i></h2>
	                    <p class="lead">We'll take the place of the speaker and make sure your voice is heard among your intended audience giving life and meaning to the subject you blog about.</p>
	                    <p>Try us today!</p>
	                    <p class="lead">
